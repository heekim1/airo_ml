...
for imei in imeis:
    ...
    joblib.dump(isolation_forest, f'isolation_forest_model_{imei}.pkl')

    # Train One-Class SVM
    one_class_svm = OneClassSVM(nu=0.01, kernel="rbf", gamma=0.1)
    one_class_svm.fit(X_scaled)
    joblib.dump(one_class_svm, f'one_class_svm_model_{imei}.pkl')
    ...
    autoencoder.save(f'autoencoder_model_{imei}.h5')
    ...
    lstm_autoencoder.save(f'lstm_autoencoder_model_{imei}.h5')
